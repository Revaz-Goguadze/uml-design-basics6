...
{
    [TestFixture]
    public class SimpleClass9Tests
    {
        ...
        public void SetUp()
        {
            ...
            this.classType = assembly.GetType("UmlDesignBasics.SimpleClass9");
        }
        ...
        [TestCase("ObjectValue", typeof(object), typeof(SimpleClass9Tests))]
        public void HasProperty(string propertyName, Type expectedPropertyType, object value)
        {
            ...
            Assert.IsTrue(propertyInfo.SetMethod.IsPublic);
